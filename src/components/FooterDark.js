...
export default function Footer() {
  return (
    <footer className="w-full sticky bottom-0 h-fit z-0 bg-primary-dark">
      <div className="mx-auto border-t border-gray-400 text-white px-[clamp(1rem,3vw,3rem)] py-[clamp(1rem,3vw,2rem)] flex flex-col gap-[clamp(1rem,2vw,2rem)]">
        <div className="container mx-auto">
          ...
          <section className="flex flex-col lg:flex-row justify-between gap-10">
            ...
            {/* Contact */}
            <section className="flex flex-col sm:flex-row gap-8 lg:gap-[clamp(1rem,3vw,3rem)] text-[clamp(0.9rem,1.2vw,1rem)]">
          ...
          {/* Social Icons */}
          <section className="flex justify-start lg:justify-end space-x-[clamp(0.5rem,1.5vw,1rem)]">
          ...
          {/* Copyright */}
          <section className="mt-[clamp(1rem,3vw,3rem)] flex justify-start lg:justify-end">
